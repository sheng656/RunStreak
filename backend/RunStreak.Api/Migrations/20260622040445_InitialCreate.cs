        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalDistanceKm = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationMinutes = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    PaceMinPerKm = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Runs_RunDate",
                table: "Runs",
                column: "RunDate");

            migrationBuilder.CreateIndex(
                name: "IX_Runs_UserId_RunDate",
                table: "Runs",
                columns: new[] { "UserId", "RunDate" });
